...
jeu1: build/regle.o build/bc.o build/bf.o build/moteur_inference.o build/interface.o build/jeu1.o
	gcc -o jeu1 build/regle.o build/bc.o build/bf.o build/moteur_inference.o build/interface.o build/jeu1.o
jeu2: build/regle.o build/bc.o build/bf.o build/moteur_inference.o build/interface.o build/jeu2.o
	gcc -o jeu2 build/regle.o build/bc.o build/bf.o build/moteur_inference.o build/interface.o build/jeu2.o
jeu3: build/regle.o build/bc.o build/bf.o build/moteur_inference.o build/interface.o build/jeu3.o
	gcc -o jeu3 build/regle.o build/bc.o build/bf.o build/moteur_inference.o build/interface.o build/jeu3.o
